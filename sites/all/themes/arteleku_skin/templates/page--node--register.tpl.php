    ...
    <div id="bloque-login" class="no-mobile">
      ...
      ?>
       ...
       <div id="bloque-social">
          <ul>
              <li><a href=""><img src="<?php print $images_url;?>/images/twitter.png"></a></li>
              <li><a href=""><img src="<?php print $images_url;?>/images/facebook.png"></a></li>
              <li><a href="feed"><img src="<?php print $images_url;?>/images/rss.png"></a></li>
          </ul>
       </div>
    </div><!-- bloque-login-->
  ...
  <?php endif; ?>
   ...
   <div id="footer">
    ...
    <div id="footer-credits">
      <div class="float-left">2012 Gipuzkoako Foru Aldundia — T 00 34 943 112 760 — Lege informazioa</div>
      <div class="float-right"><img src="<?php print file_create_url(drupal_get_path('theme', 'arteleku_skin') . '/images/gipuzkoanet.png'); ?>"></div>
    </div><!--footer-credits-->
    <div class="clear"></div>
   </div><!-- footer -->
<div id="grid"></div>
