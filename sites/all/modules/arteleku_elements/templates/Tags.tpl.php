...
<div class="xml-form-elements-tags">
  <?php print $textfield; ?>
  <input type="image" style="background-color:#ccc;border-radius:5px;" name="<?php print $add['#name'] ?>" id="<?php print $add['#id'] ?>" value="add more">
  <!--<input type="image" style="background-color:#ccc;border-radius:5px;" src="<?php print $image_path ?>add.png" name="<?php print $add['#name'] ?>" id="<?php print $add['#id'] ?>" value="add">-->
